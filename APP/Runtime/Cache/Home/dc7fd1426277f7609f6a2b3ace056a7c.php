...
<div class="hdf">
	...
	<div class="ban_left">
		...
		<div class="more">
		    <a href="__URL__/ebook" >
			--More--
		    </a>
		</div>
	    </div>
	    <div class="e_c">
		<?php if(is_array($ebook)): $i = 0; $__LIST__ = $ebook;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ebook): $mod = ($i % 2 );++$i;?><div style="border-bottom: 1px #3333ff dashed;">
	...
	<div class="ban_right">
	    ...
	    <div class="e_c">
		<?php if(is_array($code)): $i = 0; $__LIST__ = $code;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$code): $mod = ($i % 2 );++$i;?><div style="border-bottom: 1px #3333ff dashed;">
			<div style="float: left; width: 400px;">
			    <a href="__URL__/cContent/id/<?php echo ($code["id"]); ?>" title="<?php echo ($code["title"]); ?>">
