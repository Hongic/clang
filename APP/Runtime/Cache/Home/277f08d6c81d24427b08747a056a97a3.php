...
<div class="hdf">
	...
	<div class="ban_left">
		...
		<div class="more">
		    <a href="__URL__/emphasis" >
			--More--
		    </a>
		</div>
	    </div>
	    <div class="e_c">
		<?php if(is_array($emphasis)): $i = 0; $__LIST__ = $emphasis;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ebook): $mod = ($i % 2 );++$i;?><div style="border-bottom: 0px #3333ff dashed;">
			<div style="float: left; width: 400px;">
			    <a href="__URL__/emContent/id/<?php echo ($ebook["id"]); ?>" title="<?php echo ($ebook["title"]); ?>">
				<?php echo (utf8substr($ebook["title"],0,23)); ?>
			    </a>  
			</div>

			<div style="float: right">
			    <?php echo (substr($ebook["time"],0,10)); ?>
			</div>
	...
	<div class="ban_right">
	    ...
	    <div class="e_c">
		<?php if(is_array($difficult)): $i = 0; $__LIST__ = $difficult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$code): $mod = ($i % 2 );++$i;?><div style="border-bottom: 0px #3333ff dashed;">
			<div style="float: left; width: 400px;">
			    <a href="__URL__/diffContent/id/<?php echo ($code["id"]); ?>" title="<?php echo ($code["title"]); ?>">
				<?php echo (utf8substr($code["title"],0,23)); ?>
			    </a>  
			</div>
