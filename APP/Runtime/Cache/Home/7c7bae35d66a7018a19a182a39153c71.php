...
<div class="hdf">
		...
		<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ebook): $mod = ($i % 2 );++$i;?><div style="margin-bottom: 10px;">
			...
			<div style="clear: both;">
				...
				<span>
					...
					<?php echo (utf8substr($ebook["title"],0,35)); ?>
				    </a>
				</span>
			...
			<div style="clear: both;margin-bottom: 10px;">
			    ...
			    <div class="ebook_zhong_content" style="width:600px ">
	...
	<div class="pub_content_rank">
	    ...
	    <div class="rank">
		<?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><a href="__URL__/emContent/id/<?php echo ($rank["id"]); ?>">
