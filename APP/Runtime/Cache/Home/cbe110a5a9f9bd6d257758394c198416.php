...
<div class="hdf">
    ...
    <div class="main">
		...
		<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$the): $mod = ($i % 2 );++$i;?><div style="clear: both;">
			<div class="projects_title">
			    <a href="__URL__/thContent/id/<?php echo ($the["id"]); ?>" title="<?php echo ($the["title"]); ?>">
				<?php echo (utf8substr($the["title"],0,30)); ?>
			    </a>
			</div>
			<div class="news_time_right">
			    <?php echo (utf8substr($the["time"],0,10)); ?>
			</div>
		    </div>
		    <div  class="projects_content">
			<?php echo (utf8substr($the["content"],0,286)); ?>
		    </div>
	...
	<div class="pub_content_rank">
	    ...
	    <div class="rank">
		<?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><a href="__URL__/thContent/id/<?php echo ($the["id"]); ?>" title="<?php echo ($the["title"]); ?>">
