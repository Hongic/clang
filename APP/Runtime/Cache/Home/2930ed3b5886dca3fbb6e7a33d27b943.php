...
<div class="hdf">
	...
	<div>
	    <br>
	    <?php if(is_array($relation)): $i = 0; $__LIST__ = $relation;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$relation): $mod = ($i % 2 );++$i;?><div class="all_content">
		    <?php echo ($relation["content"]); ?>
