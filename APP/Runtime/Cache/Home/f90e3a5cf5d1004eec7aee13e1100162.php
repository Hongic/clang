...
<div class="hdf">
		...
		<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$code): $mod = ($i % 2 );++$i;?><div style="margin-bottom: 10px;">
			...
			<div style="clear: both;">
				...
				<span>
					...
					<?php echo (utf8substr($code["title"],0,20)); ?>
				    </a>
				</span>
	...
	<div class="pub_content_rank">
	    ...
	    <div class="rank">
		<?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><a href="__URL__/cContent/id/<?php echo ($code["id"]); ?>" title="<?php echo ($rank["title"]); ?>">
