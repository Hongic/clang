...
<div class="hdf">
	...
	<div>
	    ...
	    <?php if(is_array($intro)): $i = 0; $__LIST__ = $intro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$intro): $mod = ($i % 2 );++$i;?><div class="all_title">
		    <h1>
