...
<div class="hdf">
	...
	<div class="pub_content_left">
		...
		<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$online): $mod = ($i % 2 );++$i;?><div style="margin-bottom: 10px;border-bottom: 1px #00AAFF dotted;overflow: auto;">
			<!--      左侧：视频截图     -->
			<div class="online_left">

			    <a href="__URL__/loContent/id/<?php echo ($online["id"]); ?>" target="_blank" title="视频点击观看">
				<img src="__APP__/Uploads/Video/Pic/<?php echo ($online["pic"]); ?>">
			    </a>
			...
			<div class="online_right">
			    <div class="online_right_title">
				<?php echo (utf8substr($online["title"],0,20)); ?>
			    </div>

			    <div class="online_right_content">
				<?php echo (utf8substr($online["content"],0,130)); ?>
			    </div>

			    <div style="float: right;margin-right: 10px;">
				发布时间：<?php echo (utf8substr($online["time"],0,10)); ?>&nbsp;&nbsp;点击量：<?php echo ($online["click"]); ?>
			    </div>
	...
	<div class="pub_content_rank">
	    ...
	    <div class="rank">
		<?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><a href="__URL__/loContent/id/<?php echo ($rank["id"]); ?>" title="<?php echo ($rank["title"]); ?>">
