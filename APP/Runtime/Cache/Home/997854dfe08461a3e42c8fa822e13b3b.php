...
<div class="hdf">
	...
	<div>
	    ...
	    <?php if(is_array($us)): $i = 0; $__LIST__ = $us;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$us): $mod = ($i % 2 );++$i;?><div class="all_title">
		    <h1>
			<?php echo ($us["title"]); ?>
		    </h1>
		    <br>
		    发布者：<?php echo ($us["author"]); ?> 时间：<?php echo ($us["time"]); ?>
		</div>
