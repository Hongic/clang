...
<div class="main">
	...
	<div class="notice_content">
	    <marquee onmouseover="this.stop()" onmouseout="this.start()" scrollAmount="3" scrollDelay="100" direction="up" height="300">
		<?php echo ($notice); ?>
	    </marquee>
	</div>
	...
	<div class="news">
	    <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><div  class="news_title">
		    <a href="__URL__/content/id/<?php echo ($new["id"]); ?>" title="<?php echo ($new["title"]); ?>">
			<?php echo (utf8substr($new["title"],0,25)); ?>
		    </a>

		</div>
		<div class="news_time_right">
		    时间：<?php echo ($new["time"]); ?>
		    点击量：<?php echo ($new["click"]); ?>
		</div>

		<div class="news_content">
		    <?php echo (utf8substr($new["content"],0,130)); ?>
