...
<div class="hdf">
    ...
    <div class="main">
	    ...
	    <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$stu): $mod = ($i % 2 );++$i;?><div style="float: left;margin: 8px;">

		    <div class="stu">
			<a href="__URL__/stuContent/id/<?php echo ($stu["id"]); ?>" >
			    <img src="__APP__/Uploads/Results/m_<?php echo ($stu["pic"]); ?>">
			</a>
		    </div>

		    <div style="text-align: center;">
			<?php echo (utf8substr($stu["title"],0,10)); ?>
		    </div>
