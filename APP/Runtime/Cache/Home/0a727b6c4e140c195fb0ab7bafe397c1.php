...
<div class="hdf">
	...
	<div>
	    <br>
	    <?php if(is_array($timetable)): $i = 0; $__LIST__ = $timetable;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$timetable): $mod = ($i % 2 );++$i;?><div class="all_title">
		    <h1>
			<?php echo ($timetable["title"]); ?>
		    </h1>
		    <br>
		    发布者：<?php echo ($timetable["author"]); ?> 时间：<?php echo ($timetable["time"]); ?>
		</div>
		<div class="all_content">
		    <?php echo ($timetable["content"]); ?>
