...
<div class="hdf">
	...
	<div class="pub_content_left">
		...
		<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$code): $mod = ($i % 2 );++$i;?><div style="margin-bottom: 26px;">
			<!--      左侧 ：标题    -->

			<div class="test_titile">
			    <span>
				<a href="__URL__/tesContent/id/<?php echo ($code["id"]); ?>"  title="<?php echo ($code["title"]); ?>">
			...
			<!--    右侧：下载、时间         -->
			<div class="test_DT">
			    <a href="<?php echo ($code["yun"]); ?>" title="网盘下载">
				<img src="__PUBLIC__/Images/test.jpg" title="网盘下载" class="test_DT_img">
			    </a>
	...
	<div class="pub_content_rank">
	    ...
	    <div class="rank">
		<?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><a href="__URL__/tesContent/id/<?php echo ($code["id"]); ?>" title="<?php echo ($rank["title"]); ?>">
