...
<div class="hdf">
	...
	<div class="pub_content_left">
		...
		<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$code): $mod = ($i % 2 );++$i;?><div style="margin-bottom: 10px;">
			...
			<div style="clear: both;">
				...
				<span>
				    <a href="__URL__/claContent/id/<?php echo ($code["id"]); ?>"  title="<?php echo ($code["title"]); ?>">
					<?php echo (utf8substr($code["title"],0,26)); ?>
				    </a>
				</span>
			...
			<div style="clear: both;margin-bottom: 10px;">
				...
				<?php echo (($code["click"])?($code["click"]):"0"); ?>

			    </div>

			    <div class="ebook_zhong_content" style="width: 560px;">

				<?php echo (utf8substr($code["content"],0,100)); ?>
	...
	<div class="pub_content_rank">
	    ...
	    <div class="rank">
		<?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><a href="__URL__/claContent/id/<?php echo ($code["id"]); ?>">
