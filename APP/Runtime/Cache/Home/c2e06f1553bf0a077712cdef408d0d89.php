...
<div class="hdf">
	...
	<div class="pub_content_left">
		...
		<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$code): $mod = ($i % 2 );++$i;?><div style="margin-bottom: 10px;">
			...
			<div style="clear: both;">
				...
				<span>
				    <a href="__URL__/desContent/id/<?php echo ($code["id"]); ?>"  title="<?php echo ($code["title"]); ?>">
			...
			<div style="clear: both;margin-bottom: 10px;">
				...
				<?php echo (utf8substr($code["content"],0,89)); ?>
	...
	<div class="pub_content_rank">
	    ...
	    <div class="rank">
		<?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><a href="__URL__/desContent/id/<?php echo ($code["id"]); ?>">
