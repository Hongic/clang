...
<div class="hdf">
    ...
    <div class="main">
	    ...
	    <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$teachers): $mod = ($i % 2 );++$i;?><div style="float: left;margin: 8px;">

		    <div class="teachers">
			<a href="__URL__/tContent/id/<?php echo ($teachers["id"]); ?>" >
			    <img src="__APP__/Uploads/Team/Teachers/m_<?php echo ($teachers["pic"]); ?>">
			</a>
		    </div>

		    <div style="text-align: center;">
			<?php echo (utf8substr($teachers["title"],0,10)); ?>
		    </div>
