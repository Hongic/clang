...
<div class="hdf">
	...
	<div class="pub_content_left">
		...
		<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ebook): $mod = ($i % 2 );++$i;?><div style="margin-bottom: 10px;">
			<!--      上层 ：类型、标题、时间     -->
			<div style="clear: both;">
			    <div class="ebook_shang">
				<span class="ebook_shang_etitle">
				    电子书
				</span>
				<span>
				    <a href="__URL__/eContent/id/<?php echo ($ebook["id"]); ?>" title="<?php echo ($ebook["title"]); ?>">
					<?php echo (utf8substr($ebook["title"],0,29)); ?>
				    </a>
				</span>
			...
			<div style="clear: both;margin-bottom: 10px;">
				...
				<?php echo ($ebook["click"]); ?>

			    </div>

			    <div class="ebook_zhong_download">
				<a href="<?php echo ($ebook["yun"]); ?>" target="_blank" title="网盘下载">
				...
				<?php echo (utf8substr($ebook["content"],0,200)); ?>
	...
	<div class="pub_content_rank">
	    ...
	    <div class="rank">
		<?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><a href="__URL__/eContent/id/<?php echo ($ebook["id"]); ?>" title="<?php echo ($rank["title"]); ?>">
