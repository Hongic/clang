...
<div class="hdf">
    ...
    <div class="main">
		...
		<?php if(is_array($res)): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$the): $mod = ($i % 2 );++$i;?><div style="clear: both;">
			<div class="pub_content_left_cen">
			    <h2><?php echo ($the["title"]); ?> </h2>
			    <br>
			    发布者：<?php echo ($the["author"]); ?> 时间：<?php echo ($the["time"]); ?> 点击量：<?php echo ($the["click"]); ?>
			</div>
			<br>
	    ...
	    <!--  上一篇  -->
            <div style="margin-top: 6px;">
                <?php if(is_array($up)): $i = 0; $__LIST__ = $up;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$up): $mod = ($i % 2 );++$i;?>上一篇： <a href="__URL__/thContent/id/<?php echo ($up["id"]); ?>" title="<?php echo ($up["title"]); ?>">
                        <?php echo (utf8substr($up["title"],0,32)); ?>
                    </a>  <br><?php endforeach; endif; else: echo "" ;endif; ?>
                <?php if(is_array($next)): $i = 0; $__LIST__ = $next;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$next): $mod = ($i % 2 );++$i;?>下一篇： <a href="__URL__/thContent/id/<?php echo ($next["id"]); ?>" title="<?php echo ($next["title"]); ?>">
	...
	<div class="pub_content_rank">
	    ...
	    <div class="rank">
		<?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><a href="__URL__/thContent/id/<?php echo ($rank["id"]); ?>" title="<?php echo ($rank["title"]); ?>">
