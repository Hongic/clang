...
<div class="hdf">
    ...
    <div class="main">
        ...
        <div class="pub_content_left">
            ...
            <div style="min-height: 460px; padding: 3px">
	    ...
	    <br><br>
            ...
            <div style="margin-top: 6px;">
                <?php if(is_array($up)): $i = 0; $__LIST__ = $up;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$up): $mod = ($i % 2 );++$i;?>上一篇： <a href="__URL__/content/id/<?php echo ($up["id"]); ?>" title="<?php echo ($up["title"]); ?>">
                        <?php echo (utf8substr($up["title"],0,32)); ?>
                    </a>  <br><?php endforeach; endif; else: echo "" ;endif; ?>
                <?php if(is_array($next)): $i = 0; $__LIST__ = $next;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$next): $mod = ($i % 2 );++$i;?>下一篇： <a href="__URL__/content/id/<?php echo ($next["id"]); ?>" title="<?php echo ($next["title"]); ?>">
                        <?php echo (utf8substr($next["title"],0,50)); ?>
		...
		<?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rank): $mod = ($i % 2 );++$i;?><span> 
                        <a href="__URL__/content/id/<?php echo ($rank["id"]); ?>" title="<?php echo ($rank["title"]); ?>">
