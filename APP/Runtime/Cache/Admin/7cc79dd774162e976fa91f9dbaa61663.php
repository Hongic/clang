        ...
        <div>
            ...
            <table class="tb">
                ...
                <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "no没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="biao">
                            <img src="__ROOT__/Uploads/Video/Pic/<?php echo ($vo["pic"]); ?>" width="80px" height="60px">
                        </td>
                        <td class="biao"><?php echo (($vo["video"])?($vo["video"]):"暂无"); ?></td>
                        <td class="zhong"><?php echo (utf8substr($vo["content"],0,60)); ?></td>
                        <td class="biao"><?php echo (($vo["yun"])?($vo["yun"]):"暂无"); ?></td>
