...
<html>
    ...
    <body>
        ...
        <div>
            <a href="__GROUP__/Introduce/add" target="rightFrame">
                <input type="button" value="添加数据" class="csadd">
            </a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="__GROUP__/Introduce/browse" target="rightFrame">
        ...
        <div>
            ...
            <table class="tb">
                ...
                <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "no没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="biao">
                            <img src="__ROOT__/Uploads/Team/Introduce/s_<?php echo (($vo["pic"])?($vo["pic"]):"暂无"); ?>">
                        </td>
